...
@testset "Testing restructure_arrays" begin
    ...
    cones = MathOptInterface.AbstractVectorSet[MathOptInterface.PositiveSemidefiniteConeTriangle(3), MathOptInterface.SecondOrderCone(3), MathOptInterface.Zeros(1), MathOptInterface.Zeros(1)]

    _s, _y = restructure_arrays(s,y,cones)
